...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    luncherAdminV4AuthUserSubject.add(
      LuncherAdminV4AuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<LuncherAdminV4AuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  LuncherAdminV4AuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = LuncherAdminV4AuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    luncherAdminV4AuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
LuncherAdminV4AuthUser? currentUser;
