                                  ...
                                  child: TextFormField(
                                    controller:
                                      ...
                                      text: UserStruct.maybeFromMap(
                                              userDetailsPageGetUserByUuidResponse
                                                  .jsonBody)
                                          ?.firstName,
                                    ),
                          ...
                          child: Row(
                            ...
                            children: [
                              Theme(
                                ...
                                child: Checkbox(
                                  value: _model.userEnabledCheckboxValue ??=
                                      UserStruct.maybeFromMap(
                                              userDetailsPageGetUserByUuidResponse
                                                  .jsonBody)!
                                          .enabled,
                            ...
                            children: [
                                  ...
                                  if ((_model.updateCallResult?.succeeded ??
                                    ...
                                    if ((_model.updateCallResult?.statusCode ??
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'Nieprawidłowe dane (sprawdź hasło).',
                                            style: TextStyle(
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryText,
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    _model.deleteResult =
                                        await LuncherCoreAPIDELETEUsersUuidGroup
                                            .deleteUserCall
                                            .call(
                                      authorization: currentAuthenticationToken,
                                      uuid: widget.userId,
                                    ...
                                    if ((_model.deleteResult?.succeeded ??
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'Usunięto użytkownika pomyślnie!',
                                            style: TextStyle(
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryText,
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'Usunięcie użytkownika nieudane!',
                                            style: TextStyle(
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .secondaryBackground,
