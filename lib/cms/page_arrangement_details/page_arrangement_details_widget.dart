                      ...
                      children: [
                        ...
                        Builder(
                          builder: (context) => FFButtonWidget(
                            onPressed: () async {
                              FFAppState().editedSection = SectionDtoStruct();
                              ...
                              if (FFAppState().editedSectionAction ==
                                  ActionType.UPDATE) {
                              } else if (FFAppState().editedSectionAction ==
                                  ActionType.DELETE) {
                              } else if (FFAppState().editedSectionAction ==
                                  ActionType.CREATE) {
                                // Add new range
                                _model.updateArrangementStruct(
                                  (e) => e
                                    ..updateSections(
                                      (e) => e.add(FFAppState().editedSection),
                                    ),
                                );
                                safeSetState(() {});
                              }
                        ...
                        builder: (context) {
                          ...
                          return ReorderableListView.builder(
                            ...
                            itemBuilder: (context, sectionsIndex) {
                              ...
                              return Container(
                                key: ValueKey("ListView_nccezu32" '_' +
                                ...
                                child: Visibility(
                                  ...
                                  child: Builder(
                                    builder: (context) => InkWell(
                                      ...
                                      onTap: () async {
                                        FFAppState().editedSection = functions
                                            .cloneSectionObject(sectionsItem)!;
                                        FFAppState().editedSectionAction = null;
                                        await showDialog(
                                          context: context,
                                          builder: (dialogContext) {
